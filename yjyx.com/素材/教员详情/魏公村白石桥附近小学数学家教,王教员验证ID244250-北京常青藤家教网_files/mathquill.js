...
LatexCmds.widehat = P(MathCommand, function(_, _super) {
  _.ctrlSeq = '\\widehat';
  _.htmlTemplate =
      '<span class="non-leaf" style="margin-left:3px;">'
    +   '<span class="scaled" style="-webkit-transform:scale(5,1);">&#94;</span>'
    +   '<span class="non-leaf  widehat">&0</span>'
    + '</span>'
  ;
...
LatexCmds.overrightarrow = P(MathCommand, function(_, _super) {
  ...
  _.htmlTemplate =
      '<span class="non-leaf">'
    +   '<span class="scaled" style="-webkit-transform:scale(1.6,1);">&rarr;</span>'
    +   '<span class="non-leaf overrightarrow">&0</span>'
    + '</span>'
  ;
  _.textTemplate = ['overrightarrow(', ')'];
});
var LeftearRoot =
LatexCmds.leftear = P(MathCommand, function(_, _super) {
  _.ctrlSeq = '\\leftear';
  _.htmlTemplate =
      '<span class="paren scaled" style="-webkit-transform: scale(1.2, 2.3);">{</span>'
    + '<span class="non-leaf">'
...
var RightearRoot =
LatexCmds.rightear = P(MathCommand, function(_, _super) {
  _.ctrlSeq = '\\rightear';
  _.htmlTemplate =
      '<span class="non-leaf">'
    +   '<span class="array non-leaf">'
    ...
    + '<span class="paren scaled" style="-webkit-transform: scale(1.2, 2.3);">}</span>'
  ;
  _.textTemplate = ['rightear(', ')'];
  _.redraw = function() {
    var blockjQ = this.jQ.eq(0);
...
var TopmarkRoot =
LatexCmds.topmark = P(MathCommand, function(_, _super) {
  _.ctrlSeq = '\\topmark';
  _.htmlTemplate =
      '<span class="non-leaf">'
    +   '<span class="array non-leaf">'
