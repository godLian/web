            ...
            <div class="container2">
                <div class="uleft fl">
                    ...
                    <div class="unav">
                        ...
                        <div class="item">
                            <a href="http://longyan.ygjj.com/Teacher/PasswordManage.aspx" style="color:#f90;">更改密码</a>
                        </div>
                        <div class="item">
                ...
                <div class="uright">
                    <div class="uhead">更改密码</div>
                    <div class="ui_mainBox">
                        <div class="ui_changeBox">
                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                <tbody>
                                <tr>
                                    <td colspan="2" class="noteread">
                                        <span>温馨提示：</span>建议使用英文字母加数字或符号的组合密码。
                                    </td>
                                </tr>
                                <tr>
                                    <th>新 密 码：</th>
                                    <td>
                                        <input name="txtPassword" type="password" id="txtPassword" class="txt"><span class="Validform_checktip">请输入新密码！</span>
                                    </td>
                                </tr>
                                <tr>
                                    <th>密码确认：</th>
                                    <td>
                                        <input name="txtPassword1" type="password" id="txtPassword1" class="txt"><span class="Validform_checktip">输入新密码！</span>
                                    </td>
                                </tr>
                                <tr>
                                    <th>&nbsp;</th>
                                    <td>
                                        <input type="submit" name="btnSubmit" value=" 更新密码 " onclick="if(!CheckForm()) return false;" id="btnSubmit" class="btnReg">
                                    </td>
                                </tr>
                                </tbody>
                            </table>
