    ...
    <div class="containerBox">
        ...
        <div class="comWidth">
            ...
            <div class="container2">
                ...
                <div class="uright" style="float:left; width:854px; height:400px; overflow:hidden;border-left: #e2e2e2 solid 1px;background: #fff;">
                    ...
                    <div class="ui_mainBox">
                        <div class="ui_changeBox">
		                    ...
		                    <s:file name="myFile" label="我的图片" ></s:file>
		                    <s:textfield name="caption" label=""></s:textfield>
