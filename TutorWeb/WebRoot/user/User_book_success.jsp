...
<!--会员注册-->
    <div class="containerBox">
        ...
        <div class="comWidth">
            <!--bread-->
            <div class="bread">
                <div class="dh"> 当前位置：<a href="">首页</a> &gt; 个人中心</div>
            </div>
            <div class="container2">
                ...
                <div class="uright" style="height:100%;">
                    <div class="uhead">预约成功</div>
                    <div class="ui_mainBox">
                    	<div style="width:100%;height:100%;margin-top:15px;margin-left:15px;">订单预约成功!老师将在收到第一时间回复给您。查看<a href="<%=path%>/order/Order_detail.action?num=<"><font color="red">订单预约详情</font></a></div>
                    </div>
                </div>
                <div class="clear">
                </div>
